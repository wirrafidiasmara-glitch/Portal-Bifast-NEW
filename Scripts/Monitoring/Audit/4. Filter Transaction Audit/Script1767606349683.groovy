...
WebUI.setText(findTestObject('Menu/Monitoring/Audit/Transaction Audit/Filter_KOMI Ref'), 'a6f4519a-c0dc-49f3-85c8-c6dbc8773d25')

WebUI.delay(2)

WebUI.click(findTestObject('Menu/Monitoring/Audit/Transaction Audit/btn_Filter Data'))

WebUI.verifyTextPresent('05/01/2026 13:28', false)
