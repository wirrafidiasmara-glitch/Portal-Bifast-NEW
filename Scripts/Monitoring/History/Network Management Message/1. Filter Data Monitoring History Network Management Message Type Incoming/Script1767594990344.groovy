...
WebUI.click(findTestObject('Object Repository/Monitoring/History Network Management Message/button_Transaction Type_p-ripple p-autocomp_99ca1b'))

WebUI.click(findTestObject('Object Repository/Monitoring/History Network Management Message/span_Incoming'))
