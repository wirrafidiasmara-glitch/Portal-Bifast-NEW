...
WebUI.setText(findTestObject('Button_Global/Search'), 'RECEIVING-RFP-ACCEPTANCE')

WebUI.verifyTextPresent('Receiving Request For Payment Acceptance (Credit Transfer) - account number', false)
