...
WebUI.setText(findTestObject('Menu/Settings/Composite Config/Edit_Composite Code'), 'Testing1')

WebUI.setText(findTestObject('Menu/Settings/Composite Config/Edit_Description'), 'Katalon123')
