...
WebUI.setText(findTestObject('Menu/Settings/Composite Config/Add_Composite Code'), 'Testing')

WebUI.setText(findTestObject('Menu/Settings/Composite Config/Add_Composite Type'), 'JSON')

WebUI.click(findTestObject('Menu/Settings/Composite Config/Add_Description'))

WebUI.setText(findTestObject('Menu/Settings/Composite Config/Add_Description'), 'Katalon Test')

WebUI.click(findTestObject('Menu/Settings/Composite Config/btn_Add Step'))

WebUI.setText(findTestObject('Menu/Settings/Composite Config/AddStep_Step Name'), 'Step 1')

WebUI.setText(findTestObject('Menu/Settings/Composite Config/AddStep_Step Service'), 'Testing123')
