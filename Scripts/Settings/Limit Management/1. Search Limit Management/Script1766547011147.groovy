...
WebUI.setText(findTestObject('Button_Global/Search'), 'RFP_INIT_OUT_LIMIT_TRX_AMOUNT')

WebUI.verifyTextPresent('Limit jumlah amount per transaksi RFP Initiation Outgoing', false)
