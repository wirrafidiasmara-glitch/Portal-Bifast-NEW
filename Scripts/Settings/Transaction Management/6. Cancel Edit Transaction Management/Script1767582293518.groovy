...
WebUI.setText(findTestObject('Button_Global/Search'), 'Testing Katalon')

WebUI.click(findTestObject('Button_Global/Edit'))

WebUI.click(findTestObject('Menu/Settings/Transaction Management/Add_Incoming Status_Inactive'), FailureHandling.STOP_ON_FAILURE)
