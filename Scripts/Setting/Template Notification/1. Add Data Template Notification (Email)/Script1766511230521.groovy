...
WebUI.click(findTestObject('Template Notification/button_Add'))
...
WebUI.click(findTestObject('Template Notification/button_Submit'))

WebUI.click(findTestObject('Template Notification/button_Yes submit'))
